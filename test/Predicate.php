...
echo( '$edge = new Milko\PHPLib\Predicate( $predicates, [$predicates->KeyOffset() => "Predicate1", kTAG_NAME => ["en" => "Predicate"], "data" => "DATA"] );' . "\n" );
$edge = new Milko\PHPLib\Predicate( $predicates, [$predicates->KeyOffset() => "Predicate1", kTAG_NAME => ["en" => "Predicate"], "data" => "DATA"] );
...
//
echo( "Set predicate:\n" );
echo( '$result = $edge[ kTAG_PREDICATE_TERM ] = kPREDICATE_INSTANCE_OF;' . "\n" );
$result = $edge[ kTAG_PREDICATE_TERM ] = kPREDICATE_INSTANCE_OF;
...
//
// Instantiate predicate statically.
//
echo( "Instantiate predicate statically:\n" );
echo( '$predicate = \Milko\PHPLib\Predicate::NewPredicate( $predicates, kPREDICATE_ATTRIBUTE_OF, $src, $dst, [ "test" => "PIPPO" ] );' . "\n" );
$predicate = \Milko\PHPLib\Predicate::NewPredicate( $predicates, kPREDICATE_ATTRIBUTE_OF, $src, $dst, [ "test" => "PIPPO" ] );
echo( "Class: " . get_class( $predicate ) . "\n" );
echo( "Modified:   " . (( $predicate->IsModified() ) ? "Yes\n" : "No\n") );
echo( "Persistent: " . (( $predicate->IsPersistent() ) ? "Yes\n" : "No\n") );
